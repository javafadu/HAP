...
<link type="text/css" rel="stylesheet" href="templates/default/tab.css" />
  ...
  <table width="760" height="300" border="0" cellpadding="0" cellspacing="0">
    <tr> 
      <td height="20" valign="top" bgcolor="#FFFFFF"><table width="63%" border="1" cellpadding="0" cellspacing="15" bordercolor="efefef">
          <tr> 
            <td width="75" valign="top"><img src="images/pic1.jpg" width="72" height="85"></td>
            <td width="349" valign="top" class="mytext"><p class="mytext2 style6">DIŞ HATLAR GENEL RAPOR</p>
              <p class="mytext">
			  
			  <? $hftrp=mysql_query("select distinct(woy),year from maindata limit 0,5 ");
			  while($lsrp=mysql_fetch_array($hftrp))
			  {
			  ?>	  
			  
			   <img src="images/bul.gif" width="4" height="6" class="mytext"> <? echo"$lsrp[year]-$lsrp[woy]";?>. Hafta 
			  <br>
			  <?
			  }
			  ?><br>
            <img src="images/bul.gif" width="4" height="6"> <a href="#" class="mytext2 style9"><span class="style9">Tüm Raporlar</span></a></p></td>
          </tr>
          <tr>
            <td valign="top"><img src="images/pic2.jpg" width="72" height="85"></td>
            <td valign="top" class="mytext2"><p class="style6">İÇ HATLAR GENEL RAPOR </p>
              <p><span class="mytext">
              <? $hftrp2=mysql_query("select distinct(woy),year from maindata limit 0,5 ");
			  while($lsrp2=mysql_fetch_array($hftrp2))
			  {
			  ?>
              <img src="images/bul.gif" width="4" height="6" class="mytext"> <? echo"$lsrp2[year]-$lsrp2[woy]";?>. Hafta <br>
              <?
			  }
			  ?>
              <br>
              <img src="images/bul.gif" width="4" height="6"> <a href="#" class="mytext2 style9"><span class="style9">Tüm Raporlar</span></a></span></p></td>
          </tr>
          <tr>
            <td valign="top"><img src="images/pic1.jpg" width="72" height="85"></td>
            <td valign="top" class="mytext2"><p class="style6">HAT BAZLI RAPORLAR</p>
              <form name="form1" method="post" action="">
                <p>
                  <select name="select3" class="mytext">
				    <option value="--">Dış Hatlar</option>
				    <?
				$hatdok=mysql_query("select distinct(hat) from hatlar where mag='INT' ");
				while($hatlst=mysql_fetch_array($hatdok))
				{
				?>
                    <option value="<? echo"$hatlst[hat]"; ?>"><? echo"$hatlst[hat]"; ?></option>
				    <?
				}
				?>
                  </select>
