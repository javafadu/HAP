...
$dbtable = "geliryonetim2";// THE NAME OF YOUR DATABASE , THIS SHOULD HAVE BEEN SET WHEN YOU 
...
$serverFolder = "ProjeYeni"; // THE FOLDER IN WHICH YOU ARE RUNNING THIS SCRIPT
