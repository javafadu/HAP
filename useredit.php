...
$n++;
        ...
        { 
                $result = mysql_query("Insert into login_table(user_name,user_pass,user_email,user_level,user_dept,date,user_ip,userofis) values('$username','$userpass','$useremail','$userlevel','$user_dept','$dt','$gra','$userofis')");
                $msg2 = "";
				$msg3 = ""; 
...
<link type="text/css" rel="stylesheet" href="templates/default/tab.css" />
  ...
  <table width="760" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
          ...
          <tr> 
            <td width="486" valign="top"><div align="right">
              <form name="form1" method="post" action="useradd.php">
                <h3 align="center">Kullanýcý Düzenle</h3>
                <table width="300" border="1" align="center" cellpadding="2" cellspacing="2" bordercolor="f4f4f4">
                  <tr bgcolor="#000066">
                    <td><div align="center" class="style12 style11"><strong><span class="style10">Username </span></strong></div></td>
                    <td><div align="center" class="style12 style11"><strong><span class="style10">Departman</span></strong></div></td>
                    <td><div align="center" class="style12 style11"><strong><span class="style10">Level</span></strong></div></td>
                    <td><div align="center" class="style12 style11">
                      <div align="left"><strong><span class="style10">Mail</span></strong></div>
                    </div></td>
                    <td><span class="style15 style11">Düzenle</span></td>
                    <td><span class="style15 style11">Sil</span></td>
                  </tr>
                  <tr bgcolor="efefef">
	...
	$sqluser=mysql_query("select * from login_table ");
	while($lst=mysql_fetch_array($sqluser))
	{
	$uid=$lst[userid];
	$name=$lst[user_name];
	$dep=$lst[userofis];
	...
	?>			  
                    <td><div align="center" class="style11">
                      <div align="left"><span class="style10"><? echo"$name"; ?></span></div>
                    </div></td>
                    <td><div align="center" class="style11"><span class="style10"><? echo"$dep"; ?></span></div></td>
                    <td><div align="center" class="style11"><span class="style10"><? echo"$lev"; ?></span></div></td>
                    <td><div align="left" class="style11"><span class="style10"><? echo"$mail"; ?></span></div></td>
                    <td><div align="center"><span class="style11"><a href="useredit2.php?key=<? echo"$uid"; ?>"><img src="images/duzenle.gif" width="18" height="18" border="0"></a></span></div></td>
                    <td><div align="center"><span class="style11"><img src="images/sil.gif" width="18" height="18"></span></div></td>
                  </tr>
				  <?
				  }
				  ?>
                ...
                <p class = "smallErrorText" align="center">&nbsp;                </p>
                <p>&nbsp;</p>
              </form>
