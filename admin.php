...
<link type="text/css" rel="stylesheet" href="templates/default/tab.css" />
  ...
  <table width="760" height="300" border="0" cellpadding="0" cellspacing="0">
    <tr> 
      <td height="20" valign="top" bgcolor="#FFFFFF"><table width="60%" border="1" cellpadding="0" cellspacing="15" bordercolor="efefef">
          <tr> 
            <td width="80" valign="top"><img src="images/pic1.jpg" width="72" height="85"></td>
            <td width="635" valign="top" class="mytext"><p class="mytext2 style6"><a href="adduser.php">KULLANICI EKLE </a></p>
              <p class="mytext2 style6"><a href="useredit.php">KULLANICI DÜZENLE </a></p></td>
          </tr>
          <tr>
            <td valign="top"><img src="images/pic2.jpg" width="72" height="85"></td>
            <td valign="top" class="mytext2"><p class="style6">&nbsp;</p>
            </td>
          </tr>
          <tr>
