...
$ddd=mysql_query("select * from haftaliklf where route='$hat' order by rask DESC limit 0,1 ");
...
echo "<chart_type>line</chart_type>";
  ...
  <row>
	...
	{
	 ?>
	 <number> <? print($listele07[rask]);?></number>
  ...
  <string>2008</string>
	...
	{
	 ?>
	 <number> <? print($listele08[rask]);?></number>
