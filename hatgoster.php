...
echo"<b><font color='red' size='5'>$rt</font></b>";
?><span class="mytext2 style2"><br>
              </span></p>
              </div></td>
...
<table width="95%" border="0" align="center">
  <tr>
	...
	HEIGHT="400" 
	ALIGN="">
<PARAM NAME=movie VALUE="charts.swf?library_path=charts_library&xml_source=sample.php?hat=<? echo"$rt"; ?>">
<PARAM NAME=quality VALUE=high>
<PARAM NAME=bgcolor VALUE=#666666>

<EMBED src="charts.swf?library_path=charts_library&xml_source=sample.php?hat=<? echo"$rt"; ?>"
       quality=high 
       bgcolor=#666666  
       WIDTH="700" 
       HEIGHT="400" 
...
<table width="400" border="0" align="center" bordercolor="#990000">
  <tr bgcolor="#00CC00">
    <th scope="col"><a href="hatgoster.php?rt=<? echo"$rt"; ?>" class="style5" >LF</a></th>
    <th scope="col"><a href="hatgosterry.php?rt=<? echo"$rt"; ?>" class="style5">RY</a></th>
    <th scope="col"><a href="hatgosterrask.php?rt=<? echo"$rt"; ?>" class="style3">RASK</a></th>
    <th scope="col"><a href="hatgosterpax.php?rt=<? echo"$rt"; ?>" class="style4">PAX</a></th>
    <th scope="col"><a href="hatgostercap.php?rt=<? echo"$rt"; ?>" class="style5">CAP</a></th>
    <th scope="col"><a href="hatgostercappax.php?rt=<? echo"$rt"; ?>" class="style6">08 Cap/Pax </a></th>
    <th scope="col">&nbsp;</th>
  </tr>
  <tr bgcolor="#00CC00">
    <th scope="col"><a href="hatgosterileri1.php?rt=<? echo"$rt"; ?>" class="style4">LF</a></th>
    <th scope="col">&nbsp;</th>
    <th scope="col">&nbsp;</th>
    <th scope="col"><span class="style4 style4">PAX</span></th>
    <th scope="col"><span class="style4 style4">CAP</span></th>
    <th scope="col"><span class="style4 style4">%SA</span></th>
