 ...
 */ 
   ...
   if (!isset($year) || $year == "" || $year < 2006|| $year > 2036)
   {
      $year = date("Y");
   }
...
';
      ...
      else
      {
		...
		onClick="window.open(\''.$schurl.'\', \'schedule\', \'width=400,height=200,scrollbars=yes,resizable=yes\')">
';
         }
         else
         {
...
';
		...
		\'schedule\', \'width=400,height=200,scrollbars=yes,resizable=yes\')">
';
            echo '		'.$fvar.'
		</A>';
         }
...
';
	...
	<TD class="form" align="center" valign="bottom" width="100%" COLSPAN=7>
		...
		<TD class="form" align="left" valign="bottom">
			<b>Bugünün Tarihi:</b> '.date("j F, Y").'
		</TD>
		<TD class="form" align="left" valign="bottom">
			<b>Ay:</b> <select name="month">
';
			for ($j=1;$j<=12;$j++)
			{
			   echo'<option value='.$j;
